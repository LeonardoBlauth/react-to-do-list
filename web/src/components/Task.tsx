...
export function Task({ taskId, content, completed, onToggleTask, onDeleteTask }: TaskProps) {
  ...
  return (
    <div className={styles.content}>
      ...
      <button className={styles.status} onMouseDown={handleToggleTask}>
          {completed ? (
          ...
          >
            <path
              d="M8.98007 16.4262C13.0726 16.4262 16.3903 13.1085 16.3903 9.01593C16.3903 4.92336 13.0726 1.60568 8.98007 1.60568C4.8875 1.60568 1.56982 4.92336 1.56982 9.01593C1.56982 13.1085 4.8875 16.4262 8.98007 16.4262Z"
              fill="#5E60CE"
            />
            <path
            ...
            />
            <path
              d="M12.4306 6.34212L8.09865 10.6741L5.61618 8.19159L4.78027 9.0275L8.09865 12.3459L13.2665 7.17803L12.4306 6.34212Z"
              fill="#F2F2F2"
            />
          </svg>
          </i>
      ...
      <button className={styles.trash} onMouseDown={handleDeleteTask}>
        <Trash size={15} />
      </button>
    </div>
  );
